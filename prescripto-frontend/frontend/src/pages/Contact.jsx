    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-text-medium leading-relaxed'>54709 Willms Station <br /> Suite 350, Washington, USA</p>
          <p className='text-text-medium leading-relaxed'>Tel: <span className='text-primary font-semibold'>(415) 555-0132</span> <br /> Email: <span className='text-primary font-semibold'>contact@prescripto.com</span></p>
          <p className='font-bold text-xl text-text-dark'>CAREERS AT PRESCRIPTO</p>
